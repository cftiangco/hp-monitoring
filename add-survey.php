...
if(isset($_POST['submit'])) {
    ...
    if($result) {
        header('Location: additional-survey.php?id=' . $result->id);
    }
}
            ...
            <div class="p-3">
                ...
                <div class="grid grid-cols-1 gap-1 md:grid-cols-3 md:gap-3 md:space-x-5">
                    ...
                    <div class="flex flex-col gap-y-2 mb-3">
                        ...
                        <input type="number" name="household_head_age" id="household_head_age" class="bg-gray-50 outline-none border px-3 py-2 rounded w-auto hover:border-2 hover:border-blue-300 hover:bg-white" <?= $required ? 'required':'' ?>>
                    </div>
                ...
                <div class="grid grid-cols-1 gap-1 md:grid-cols-3 md:gap-3 md:space-x-5">
                    ...
                    <div class="flex flex-col gap-y-2 mb-3">
                        ...
                        <input type="text" placeholder="Grade/HS/College" name="household_head_student_grade" id="household_head_student_grade" class="bg-gray-50 outline-none border px-3 py-2 rounded w-auto hover:border-2 hover:border-blue-300 hover:bg-white" <?= $required ? 'required':'' ?>>
                    </div>

                    <div class="flex flex-col gap-y-2 mb-3">
                        <label for="household_head_occupation">Trabaho</label>
                        <input type="text" name="household_head_occupation" id="household_head_occupation" class="bg-gray-50 outline-none border px-3 py-2 rounded w-auto hover:border-2 hover:border-blue-300 hover:bg-white" <?= $required ? 'required':'' ?>>
                    </div>
                ...
                <div class="grid grid-cols-1 gap-1 md:grid-cols-3 md:gap-3 md:space-x-5">
                    ...
                    <div class="flex flex-col gap-y-2 mb-3">
                        ...
                        <input type="number" name="household_head_salary" id="household_head_salary" class="bg-gray-50 outline-none border px-3 py-2 rounded w-auto hover:border-2 hover:border-blue-300 hover:bg-white" <?= $required ? 'required':'' ?>>
                    </div>
                ...
                <div class="grid grid-cols-1 gap-1 md:grid-cols-3 md:gap-3 md:space-x-5">
                    ...
                    <div class="flex flex-col gap-y-2 mb-3">
                        ...
                        <input type="text" name="household_head_disability_type" id="household_head_disability_type" class="bg-gray-50 outline-none border px-3 py-2 rounded w-auto hover:border-2 hover:border-blue-300 hover:bg-white" <?= $required ? 'required':'' ?>>
                    </div>
                ...
                <div class="grid grid-cols-1 gap-1 md:grid-cols-3 md:gap-3 md:space-x-5">
                    ...
                    <div class="flex flex-col gap-y-2 mb-3">
                        ...
                        <input type="text" name="partner_name" id="partner_name" class="bg-gray-50 outline-none border px-3 py-2 rounded w-auto hover:border-2 hover:border-blue-300 hover:bg-white" <?= $required ? 'required':'' ?>>
                    </div>

                    <div class="flex flex-col gap-y-2 mb-3">
                        <label for="partner_birthday">Birthday</label>
                        <input type="date" name="partner_birthday" id="partner_birthday" class="bg-gray-50 outline-none border px-3 py-2 rounded w-auto hover:border-2 hover:border-blue-300 hover:bg-white" <?= $required ? 'required':'' ?>>
                    </div>

                    <div class="flex flex-col gap-y-2 mb-3">
                        <label for="partner_age">Edad</label>
                        <input type="number" name="partner_age" id="partner_age" class="bg-gray-50 outline-none border px-3 py-2 rounded w-auto hover:border-2 hover:border-blue-300 hover:bg-white" <?= $required ? 'required':'' ?>>
                    </div>
                ...
                <div class="grid grid-cols-1 gap-1 md:grid-cols-3 md:gap-3 md:space-x-5">
                    ...
                    <div class="flex flex-col gap-y-2 mb-3">
                        ...
                        <input type="text" placeholder="Grade/HS/College" name="partner_grade" id="partner_grade" class="bg-gray-50 outline-none border px-3 py-2 rounded w-auto hover:border-2 hover:border-blue-300 hover:bg-white" <?= $required ? 'required':'' ?>>
                    </div>

                    <div class="flex flex-col gap-y-2 mb-3">
                        <label for="partner_occupation">Trabaho</label>
                        <input type="text" name="partner_occupation" id="partner_occupation" class="bg-gray-50 outline-none border px-3 py-2 rounded w-auto hover:border-2 hover:border-blue-300 hover:bg-white" <?= $required ? 'required':'' ?>>
                    </div>
                ...
                <div class="grid grid-cols-1 gap-1 md:grid-cols-3 md:gap-3 md:space-x-5">
                    ...
                    <div class="flex flex-col gap-y-2 mb-3">
                        ...
                        <input type="number" name="partner_salary" name="partner_salary" class="bg-gray-50 outline-none border px-3 py-2 rounded w-auto hover:border-2 hover:border-blue-300 hover:bg-white" <?= $required ? 'required':'' ?>>
                    </div>
                ...
                <div class="grid grid-cols-1 gap-1 md:grid-cols-3 md:gap-3 md:space-x-5">
                    ...
                    <div class="flex flex-col gap-y-2 mb-3">
                        ...
                        <input type="number" name="partner_age_of_gestation" id="partner_age_of_gestation" class="bg-gray-50 outline-none border px-3 py-2 rounded w-auto hover:border-2 hover:border-blue-300 hover:bg-white" <?= $required ? 'required':'' ?>>
                    </div>

                    <div class="flex flex-col gap-y-2 mb-3">
                        <label for="lmp">LMP</label>
                        <input type="date" name="lmp" id="lmp" class="bg-gray-50 outline-none border px-3 py-2 rounded w-auto hover:border-2 hover:border-blue-300 hover:bg-white" <?= $required ? 'required':'' ?>>
                    </div>
                ...
                <div class="grid grid-cols-1 gap-1 md:grid-cols-3 md:gap-3 md:space-x-5">
                    ...
                    <div class="flex flex-col gap-y-2 mb-3">
                        ...
                        <input type="date" name="edc" id="edc" class="bg-gray-50 outline-none border px-3 py-2 rounded w-auto hover:border-2 hover:border-blue-300 hover:bg-white" <?= $required ? 'required':'' ?>>
                    </div>
                ...
                <div class="grid grid-cols-1 gap-1 md:grid-cols-3 md:gap-3 md:space-x-5">
                    ...
                    <div class="flex flex-col gap-y-2 mb-3">
                        ...
                        <input type="text" name="family_planning_methodtype" id="family_planning_methodtype" class="bg-gray-50 outline-none border px-3 py-2 rounded w-auto hover:border-2 hover:border-blue-300 hover:bg-white" <?= $required ? 'required':'' ?>>
                    </div>
                    ...
                    <div class="flex flex-col gap-y-2 mb-3">
                        ...
                        <input type="text" name="disability_type" id="disability_type" class="bg-gray-50 outline-none border px-3 py-2 rounded w-auto hover:border-2 hover:border-blue-300 hover:bg-white" <?= $required ? 'required':'' ?>>
                    </div>
                ...
                <div class="grid grid-cols-1 gap-1 md:grid-cols-3 md:gap-3 md:space-x-5">
                    ...
                    <div class="flex flex-col gap-y-2 mb-3">
                        ...
                        <input type="text" name="type_of_animals" id="type_of_animals" class="bg-gray-50 outline-none border px-3 py-2 rounded w-auto hover:border-2 hover:border-blue-300 hover:bg-white" <?= $required ? 'required':'' ?>>
                    </div>
